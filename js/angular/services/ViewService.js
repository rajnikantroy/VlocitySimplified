...
var faq = '<b>1. What is Vlocity Simplified?</b><br/>'+
'Vlocity Simplified is chrome extension by installing it, it enables you to see your recently created/modified components.<br/><br/>'+
'<b>2. Why should i use Vlocity Simplified?</b><br/>'+
'Vlocity Simplified is time saver machine, which will help you find your components by avoiding unnecessary clicks.<br/><br/>'+
'<b>3. Will it work on multiple org simultaneously?</b><br/>'+
'Yes! You can use this tool for multiple org simultaneously.<br/><br/>'+
'<b>4. Vlocity Simplified is unable to show my data, What should i do?</b><br/>'+
...
'<b>10. Is there any shortcut to close Vlocity Simplified?</b><br/>'+
...
'   <tr><td colspan="2"><h3>Vlocity Simplified</h3></td></tr>'+
'   <tr><td colspan="2"><a href="https://github.com/rajnikantroy/Salesforce-Simplified" target="_blank" title="See how you can use Vlocity Simplified.">How to use</a></td></tr>'+
...
'   <tr><td colspan="2"><a href="mailto:rajkant020@gmail.com?subject=Feedback/Suggestions of Vlocity Simplified" title="If you have any feedback/suggestions, please mailto rajkant020@gmail.com." target="_blank">Feedback and Suggestions</a></td></tr>'+
...
'<img ng-switch-when="RecentlyViewed" class="menuicon" src="'+recentitems+'"/>'+
'<img ng-switch-when="DebugLogs" class="menuicon" src="'+debuglogs+'"/>'+
'<img ng-switch-when="Omniscript" class="menuicon" src="'+pages+'"/>'+
'<img ng-switch-when="Templates" class="menuicon" src="'+staticresources+'"/>'+
'<img ng-switch-when="DataRaptor" class="menuicon" src="'+database+'"/>'+
'<img ng-switch-when="Cards" class="menuicon" src="'+workflows+'"/>'+
'<img ng-switch-when="Classes" class="menuicon" src="'+classes+'"/>'+
'<img ng-switch-when="Objects" class="menuicon" src="'+objects+'"/>'+
//'<img ng-switch-when="Fields" class="menuicon" src="'+fields+'"/>'+
'<img ng-switch-when="AuraDefinitionBundle" class="menuicon" src="'+AuraDefinitionBundles+'"/>'+
...
'   <td ng-if="r.Name" Class="tooltip-me" data-title="{{r.Name}}"><a Class="trim-info-content" href="{{baseUrl}}/{{selectedMetadata.midurl}}{{r.Id}}" target="_blank">{{r.Name}} <span ng-if="r.vlocity_cmt__IsActive__c">*</span> <span ng-if="r.vlocity_cmt__Active__c">*</span> <span ng-if="r.IsActive">*</span></a></td>'+
...
'<tr><th><center>'+
'<input type"text" placeholder="Quick find" ng-model="searchMetadataLeft">'+
'<center></th></tr>'+
'<tr ng-click="detailsPopupOpen(menu)" ng-repeat="menu in allMenu | filter:searchMetadataLeft ">'+
...
'</header>'+
  ...
  '<td class="bold"><a target="_blank" href="https://salesforcesimplify.blogspot.com">Vlocity Simplified</a></td>'+
'</tr></table>'+
'</footer>'+
'</div>'+
'</div>'+
...
//'<span class="salesforcesimplifiedTitle">Vlocity Simplified (We are open source now)</span>'+
//'</div>'+
